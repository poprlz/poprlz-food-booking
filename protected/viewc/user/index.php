...
<body>
  ...
  <div id="mainBody">
    ...
    <div id="login_box">
      ...
      <?php 
        if(isset($data['auth_error'])){
            echo '<ul>';
            foreach ($data['auth_error'] as $key => $value) {
               echo '<li>'.$value.'</li>';
            }
            echo '</ul>';
      ...
      ?>
       <form action="<?php echo Doo::conf()->APP_URL.'index.php/user/auth.html';?>" method="post">
    ...
    <div  id="register_box">
       <?php 
        if(isset($data['register_error'])){
            echo '<ul>';
            foreach ($data['register_error'] as $key => $value) {
               echo '<li>'.$value.'</li>';
            }
            echo '</ul>';
      ...
      ?>
       <form action="<?php echo Doo::conf()->APP_URL.'index.php/user/register.html';?>" method="post">
            <input type="text" name="email"/>
            <input type="password" name="password"/>
