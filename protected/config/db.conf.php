 ...
 */
 ...
 $dbmap['User']['has_many']['UserAccount'] = array('foreign_key'=>'user_id');
 $dbmap['UserAccount']['belongs_to']['User'] = array('foreign_key'=>'id');

 $dbconfig['dev'] = array('127.0.0.1', 'poprlz_food_booking', 'root', '123456', 'mysql', true);
 $dbconfig['prod'] = array('127.0.0.1', 'poprlz_food_booking', 'root', '123456', 'mysql', true);
